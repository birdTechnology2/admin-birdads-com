// lib/other_requests/facebook_requests.dart
...
class ReadyFacebookPagesPage extends StatefulWidget {
  @override
  _ReadyFacebookPagesPageState createState() => _ReadyFacebookPagesPageState();
}

class _ReadyFacebookPagesPageState extends State<ReadyFacebookPagesPage> {
  final CollectionReference requests = FirebaseFirestore.instance.collection('pages_ready_requests');
  String searchQuery = "";
  ...
  Future<void> _checkUserPermissions() async {
    ...
    if (savedUsername != null) {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        setState(() {
          canEditStatus = (doc.data() as Map<String, dynamic>)['permissions_facebook_requests_edit'] ?? false;
        });
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('طلبات صفحات فيسبوك - مرحبًا بك يا $userName'),
      ),
      body: Padding(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        _buildReadOnlyRow(requestData, 'description', 'تفاصيل الصفحة', textColor),
                                        ...
                                        _buildReadOnlyRow(requestData, 'pageName', 'اسم الصفحة', textColor),
