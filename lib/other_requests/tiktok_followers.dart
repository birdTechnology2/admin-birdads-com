// lib/other_requests/tiktok_followers.dart
...
class TikTokFollowersPage extends StatefulWidget {
  @override
  _TikTokFollowersPageState createState() => _TikTokFollowersPageState();
}

class _TikTokFollowersPageState extends State<TikTokFollowersPage> {
  final CollectionReference requests = FirebaseFirestore.instance.collection('tiktok_followers_requests');
  String searchQuery = "";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('طلبات تزويد متابعين تيك توك - مرحبًا بك يا $userName'),
      ),
      body: Padding(
