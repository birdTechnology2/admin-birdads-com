// lib/other_requests/facebook_followers.dart
...
class FacebookFollowersPage extends StatefulWidget {
  @override
  _FacebookFollowersPageState createState() => _FacebookFollowersPageState();
}

class _FacebookFollowersPageState extends State<FacebookFollowersPage> {
  final CollectionReference requests = FirebaseFirestore.instance.collection('fb_followers_requests');
  String searchQuery = "";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('طلبات تزويد متابعين فيسبوك - مرحبًا بك يا $userName'),
      ),
      body: Padding(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Divider(),
                                        _buildReadOnlyRow(requestData, 'fbLink', 'رابط فيسبوك', textColor),
        ...
        Expanded(
          child: GestureDetector(
            ...
            child: Text(
              ...
              style: TextStyle(fontSize: 16, color: fieldKey == 'fbLink' ? Colors.blue : textColor, decoration: fieldKey == 'fbLink' ? TextDecoration.underline : null),
            ),
          ),
        ),
      ],
