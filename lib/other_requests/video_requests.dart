// lib/other_requests/video_requests.dart
...
class VideoRequestsPage extends StatefulWidget {
  @override
  _VideoRequestsPageState createState() => _VideoRequestsPageState();
}

class _VideoRequestsPageState extends State<VideoRequestsPage> {
  final CollectionReference requests = FirebaseFirestore.instance.collection('video_requests');
  String searchQuery = "";
  ...
  Future<void> _checkUserPermissions() async {
    ...
    if (savedUsername != null) {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        setState(() {
          canEditStatus = (doc.data() as Map<String, dynamic>)['permissions_video_requests_edit'] ?? false;
        });
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('طلبات الفيديو - مرحبًا بك يا $userName'),
      ),
      body: Padding(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Divider(),
                                        _buildReadOnlyRow(requestData, 'facebookLink', 'رابط فيسبوك', textColor),
                                        _buildReadOnlyRow(requestData, 'description', 'تفاصيل الفيديو', textColor),
