// lib/content_requests_page.dart
...
class ContentRequestsPage extends StatefulWidget {
  @override
  _ContentRequestsPageState createState() => _ContentRequestsPageState();
}

class _ContentRequestsPageState extends State<ContentRequestsPage> {
  final CollectionReference requests = FirebaseFirestore.instance.collection('content_requests');
  String searchQuery = "";
  ...
  Future<void> _checkUserPermissions() async {
    ...
    if (savedUsername != null) {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        setState(() {
          canEditStatus = (doc.data() as Map<String, dynamic>)['permissions_content_requests_edit'] ?? false;
        });
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('طلبات المحتوى - مرحبًا بك يا $userName'),
      ),
      body: Padding(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Divider(),
                                        _buildReadOnlyRow(requestData, 'facebookLink', 'لينك الفيس بوك', textColor),
                                        _buildReadOnlyRow(requestData, 'contentDetails', 'تفاصيل المحتوى', textColor),
        ...
        Expanded(
          child: GestureDetector(
            ...
            child: Text(
              ...
              style: TextStyle(fontSize: 16, color: fieldKey == 'facebookLink' ? Colors.blue : textColor, decoration: fieldKey == 'facebookLink' ? TextDecoration.underline : null),
            ),
          ),
        ),
      ],
